...
async function main() {
  ...
  for (const migration of ["0001_foundation.sql", "0002_analysis_mvp.sql", "0007_identity_workspaces_credits.sql", "0010_batch_domain.sql", "0011_batch_retention.sql", "0012_asset_original_filename.sql", "0013_check_packs.sql", "0017_saved_products.sql"]) {
