...
| SG-C04 | P0 | `DONE` | Founder/Growth | Approved test assets | Six founder-approved controlled comparisons published with optimized original/candidate assets and no internal telemetry: logo, printed value, packaging shape, main color, missing component, and product count |
