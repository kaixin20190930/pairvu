...
| SG-M05 | P2 | `IN_PROGRESS` | Founder/Product | Founder approval and controlled evidence | Category quality gate adopted 2026-08-03; Cosmetics is the first public flagship, while beverage, personal care, and packaged food remain planned/noindex until they pass the same standard; platform and generator clusters remain blocked pending separate approval |
